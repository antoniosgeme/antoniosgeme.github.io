...
%    \end{itemize}
    ...
    \subsection*{Conference Articles}
        \nocite{*}
        \printbibliography[type=inproceedings, heading=none, resetnumbers, notkeyword=baps]

     \subsection*{Conference Abstracts}
        \nocite{*}
        \printbibliography[type=inproceedings, heading=none, resetnumbers, keyword=baps]
