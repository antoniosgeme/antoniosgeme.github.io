...
%    \end{itemize}
	...
	\end{tablist}
     ...
     %\begin{tablist}
        ...
        %\item[2023] \tab{}Xu X., Gementzopoulos A., Sedky G., Jones A. R., and Lagor F., %\enquote{Optimal Wing Maneuvers Design in a Transverse Gust Encounter Using Iterative Input-output Optimization}, (under review)
    
        %\item[2023] \tab{}Sedky G., Gementzopoulos A., Lagor F.,and Jones A. R., \enquote{Experimental mitigation of large-amplitude transverse gusts via closed-loop pitch control}, (under review)

        %\item[2022] \tab{}Gementzopoulos A., Sedky G., and Jones A. R., \enquote{On the role of vorticity distribution in the rise and fall of lift during a transverse gust encounter.} , (under review)

        %\item[2022] \tab{}Sedky, G., Gementzopoulos, A., Andreu-Angulo, I., Lagor, F. D., and Jones, A. R. (2022).,  \enquote{Physics of gust response mitigation in open-loop pitching manoeuvres.} \textit{Journal of Fluid Mechanics, 944}, \href{https://doi.org/10.1017/jfm.2022.509}{doi:10.1017/jfm.2022.509}
        
        %\item[2022] \tab{}Xu X., Gementzopoulos A., Sedky G., Jones A. R., and Lagor F., \enquote{Iterative Maneuver Optimization in a Transverse Gust Encounter.} \textit{American Institute of Aeronautics and Astronautics Journal},\href{https://doi.org/10.2514/1.J062404}{doi:10.2514/1.J062404}
%\end{tablist}
%\subsection*{Conference Papers}

    %\begin{tablist}
    
    %\item[2022] \tab{}Gementzopoulos, A., Sedky, G., and Jones, A. (2022)., \enquote{Lift and vortex development during transverse wing-gust encounters for a blunt-edge airfoil.} \textit{ In AIAA Scitech 2022 Forum (p. 0045).}\href{https://doi.org/10.2514/6.2022-0045}{doi:10.2514/6.2022-0045}  
           

       %\item[2022] \tab{}Sedky, G., Gementzopoulos, A., Lagor, F. D., and Jones, A. (2022). \enquote{Experiments in transverse gust mitigation using open-loop pitch maneuvers.} \textit{In AIAA Scitech 2022 Forum (p. 0333).} \href{https://doi.org/10.2514/6.2022-0333}{doi:10.2514/6.2022-0333}
   ...
   % \end{tablist}
	...
	%\subsection*{Conference Abstracts}
       ...
       %\item[2022] \tab{}Gementzopoulos, A., Sedky, G., and Jones, A. (2022)., \enquote{Predicting Lift in Unsteady Separated Flows using Classical Aerodynamics.} \textit{ Bulletin of the American Physical Society.}
       
       
		%\item[2022] \tab{}Sedky, G., Gementzopoulos, A., Lagor, F., and Jones, A. (2022). , \enquote{Transverse gust mitigation via closed-loop control.} \textit{ Bulletin of the American Physical Society.}
		
       
       	%\item[2022] \tab{}Peterson, S., Rosen, M., Gementzopoulos, A., Zhang, P., and Porfiri, M. \enquote{Cause-and-effect relationships in tandem swimmer models using transfer entropy.} \textit{ Bulletin of the American Physical Society.}
...
%       
%      \subsection*{Panel Presentations}
%    
%    
%
%    \begin{tablist}
%    
%\item[2022] \tab \enquote{Progress in Transverse Gust Mitigation.} \\
%NATO AVT--$347$, May 2022
%
%
%\item[2021] \tab \enquote{Experiments in Transverse Gust Mitigation Using Open Loop Pitch Maneuvers} \\ 
%NATO AVT--$347$, Oct. 2022
%
%\item[2021] \tab \enquote{Experimental Investigation and Mitigation of Transients during Gust Encounters} \\
% NATO AVT--$347$, May 2021
%
%  
%    \end{tablist}
%    
...
%    
%    \begin{tablist}
%   \item[2022] \tab \enquote{Lift and vortex development during transverse wing-gust encounters for a blunt-edge airfoil.} \\ AIAA SCITECH Forum, Jan. 2022
%     \end{tablist}
%
%    
