...
\begin{document}
    ...
    \vspace{1.5mm}
        ...
        Imaging Evolution (STORIE) mission. Emphasis is placed on software development for data acquisition, visualization and data analysis for the 
        energetic neutral atom imager, aimed at studying space weather energy transfer from the Sun to Earth. \\\
