...
%    \end{itemize}
    ...
    \subsection*{Journal Articles}
        \nocite{*}
        \printbibliography[type=article,heading=none,resetnumbers, notkeyword=abstract]

    \subsection*{Conference Articles}
        \nocite{*}
        \printbibliography[type=inproceedings, heading=none, resetnumbers, notkeyword=abstract]

     \subsection*{Conference Abstracts}
        \nocite{*}
        \printbibliography[heading=none, resetnumbers, keyword=abstract]
